/usr/local/gcc49/bin/g++49 -o proxy \
  proxy.cpp ../gen-cpp2/Calculator.cpp ../gen-cpp2/Calculator_client.cpp ../gen-cpp2/calculator_constants.cpp ../gen-cpp2/calculator_types.cpp \
