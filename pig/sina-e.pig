...
--raw_data = load '/mvad/rawlog/dsp-extended/2015-08-18/{14.d.e.3-*,15.d.e.3-*}' using com.twitter.elephantbird.pig.load.LzoThriftB64LinePigLoader('dsp.thrift.ExtendedData');
raw_data = load '15.d.e.3-9-kf36dg.prod.mediav.com-9092-29071996604.ext.dsp.lzo' using com.twitter.elephantbird.pig.load.LzoThriftB64LinePigLoader('dsp.thrift.ExtendedData');
...
--C = FILTER B BY data#'imp.banner.w'!=300 AND data#'imp.banner.h' == 10;
